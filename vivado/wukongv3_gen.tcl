...
# Create project
create_project -force ${project_name} vivado/ -part xc7a100tfgg676-1
...
set files [list \
 "[file normalize "$origin_dir/src/vhdl/clocking_wukongv3.vhdl"]"\
 ...
 "[file normalize "$origin_dir/src/vhdl/wukongv3.vhdl"]"\
...
set file "vhdl/clocking_wukongv3.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "vhdl/wukongv3.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/vhdl/wukongv3.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/wukongv3.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a100tfgg676-1 -flow {Vivado Synthesis 2023} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a100tfgg676-1 -flow {Vivado Implementation 2023} -strategy "Congestion_SpreadLogic_high" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
